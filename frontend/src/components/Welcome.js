...
class Welcome extends React.Component {
  ...
  onRowClick(row, columnIndex, rowIndex, e) {
    this.props.history.push({
      pathname: '/coinInfo', search: '?query=' + row.coinName,
      state: {
        param: {
          'id': row.id,
      ...
      <div className="welcomeoverall">
        ...
        <div>
          ...
          >
            ...
            <TableHeaderColumn width="5%" dataField="rank" headerAlign='center' dataAlign='center' dataSort={true} isKey={true}>Rank</TableHeaderColumn>
            <TableHeaderColumn width="10%" dataField="coinName" headerAlign='center' dataAlign='center' dataSort={true}>CoinName</TableHeaderColumn>
            <TableHeaderColumn width="10%" dataField="coinSymbol" headerAlign='center' dataAlign='center' dataSort={true}>CoinSymbol</TableHeaderColumn>
            <TableHeaderColumn width="15%" dataField="coinCirculatingSupply" dataSort={true}>Circulating Supply</TableHeaderColumn>
            <TableHeaderColumn width="10%" dataField="price" dataFormat={priceFormatter} dataSort={true}>Price(USD)</TableHeaderColumn>
